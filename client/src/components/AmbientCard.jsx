...
function AmbientCard() {
  ...
  return (
    <div className="flex flex-col   bg-[#d2ff02] py-10 px-8 sm:p-10 rounded-3xl sm:rounded-lg  justify-around w-full">
      <h1 className="pb-8 font-extrabold text-2xl ">AMBIENT MUSIC</h1>
